...
START_TEST(strncat_1) {
  ...
  char b11[1024] = "";
  char str_1_2[1024] = "LUGANO THE BEST!";
  s21_strncat(b11, str_1_2, n1);
  strncat(b1, str_1_2, n1);
  int a = strcmp(b1, b11);
  ck_assert_int_eq(a, 0);
}
END_TEST
...
START_TEST(strncat_2) {
  ...
  char b22[1024] = "THE";
  char str_2_2[1024] = " BEST!!";
  s21_strncat(b22, str_2_2, n2);
  strncat(b2, str_2_2, n2);
  int a = strcmp(b2, b22);
  ck_assert_int_eq(a, 0);
}
END_TEST
...
START_TEST(strncat_3) {
  ...
  char b33[1024] = "777";
  char str_3_2[1024] = " LUGANO!";
  s21_strncat(b33, str_3_2, n3);
  strncat(b3, str_3_2, n3);
  int a = strcmp(b3, b33);
  ck_assert_int_eq(a, 0);
}
END_TEST
...
START_TEST(sprintf_float_flags) {
  ...
  ck_assert_str_eq(str1, " 0.000000");
}
END_TEST
...
START_TEST(sprintf_test_sprintf0) {
  char str1[BUFF_SIZE];
  char str2[BUFF_SIZE];
  char format[] = "%lld %hhd";
...
START_TEST(test999) {
  ...
  s21_sprintf(str1, format, 20.999);
  sprintf(str2, format, 20.999);
  ck_assert_str_eq(str1, str2);
}
END_TEST
...
int main(void) {
  ...
  TCase *tc = tcase_create("TESTS_tc");
  ...
  tcase_add_test(tc, sprintf_test_sprintf0);
