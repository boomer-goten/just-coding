...
echo -e "${color_1}SPACE_ROOT${NORMAL[0]} = ${color_2}$SPACE_ROOT MB${NORMAL[0]}"
else
SPACE_ROOT=$(bc<<<"scale=3;$SPACE_ROOT/1024")
echo -e "${color_1}SPACE_ROOT${NORMAL[0]} = ${color_2}0$SPACE_ROOT MB${NORMAL[0]}"
fi
if [ $SPACE_ROOT_USED -ge 1024 ]
then
SPACE_ROOT_USED=$(bc<<<"scale=2;$SPACE_ROOT_USED/1024")
echo -e "${color_1}SPACE_ROOT_USED${NORMAL[0]} = ${color_2}$SPACE_ROOT_USED MB${NORMAL[0]}"
else
SPACE_ROOT_USED=$(bc<<<"scale=3;$SPACE_ROOT_USED/1024")
echo -e "${color_1}SPACE_ROOT_USED${NORMAL[0]} = ${color_2}0$SPACE_ROOT_USED MB${NORMAL[0]}"
fi
if [ $SPACE_ROOT_FREE -ge 1024 ]
then
SPACE_ROOT_FREE=$(bc<<<"scale=2;$SPACE_ROOT_FREE/1024")
echo -e "${color_1}SPACE_ROOT_FREE${NORMAL[0]} = ${color_2}$SPACE_ROOT_FREE MB${NORMAL[0]}"
else
SPACE_ROOT_FREE=$(bc<<<"scale=3;$SPACE_ROOT_FREE/1024")
echo -e "${color_1}SPACE_ROOT_FREE${NORMAL[0]} = ${color_2}0$SPACE_ROOT_FREE MB${NORMAL[0]}"
fi